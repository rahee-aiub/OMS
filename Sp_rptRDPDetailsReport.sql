...
/****** Object:  StoredProcedure [dbo].[Sp_rptRDPDetailsReport]    Script Date: 04/07/2019 1:41:10 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[Sp_rptRDPDetailsReport] (@fDate VARCHAR(10),@tDate VARCHAR(10))
...
EXECUTE Sp_rptRDPDetailsReport '2019-03-02','2019-03-04'
...
------ Order Informations
	...
	-------------------------------------------------------------------------------
		...
		SELECT * FROM WFRDPDETAILS ORDER BY TrnDate,LineSL 
