<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="A2ZOrderPositionReport.aspx.cs" Inherits="ATOZWEBOMS.Pages.A2ZOrderPositionReport" %>
        ...
        <table class="style1">
            ...
            <tr>
                <td>
                    ...
                    &nbsp;
                    <asp:Label ID="Label3" runat="server" Text="Order Party : " Width="120px" Font-Size="Large" ForeColor="Red"></asp:Label>

                </td>
                <td>

                    <asp:DropDownList ID="ddlOrderParty" runat="server" Enabled="false" CssClass="cls text" Width="200px" Height="35px" BorderColor="#1293D1" BorderStyle="Ridge"
