...
{
    public partial class A2ZOMSReEditOrder : System.Web.UI.Page
    {
        ...
        {
            string sqlquery = "SELECT OrderNo,OrderNo FROM A2ZORDERDETAILS WHERE OrderStatus = 12 OR OrderStatus = 13 OR OrderStatus = 14 OR OrderStatus = 15";
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                prm[7] = "13";//OrderStatus
                prm[8] = "Re-Edit Order";//OrderStatusDesc;
                ...
                // prm[12] = "0"; //ItemImage;
                prm[12] = ddlKarat.SelectedValue; //ItemSize;
                prm[13] = txtSize.Text; //ItemSize;
                prm[14] = txtLength.Text; //ItemLength;
                prm[15] = txtPiece.Text; //ItemQuantity;
                prm[16] = txtWide.Text; //ItemWide;    
                prm[17] = txtWeight.Text; //ItemWeight;
                prm[18] = txtColor.Text; //ItemColor;     
                ...
                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_ReEditOrder", prm, "A2ZACOMS"));
                if (result == 0)
                {
                    Response.Redirect(Request.RawUrl);
                }
