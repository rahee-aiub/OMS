...
{
    public partial class A2ZOMSFactoryReady : System.Web.UI.Page
    {
        ...
        protected void btnReady_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                prm[2] = "16";//OrderStatus
                prm[3] = "Factory Ready";//OrderStatusDesc;
                

                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_OrderFactoryReady", prm, "A2ZACOMS"));
                if (result == 0)
                {
                    Response.Redirect(Request.RawUrl);
                }
