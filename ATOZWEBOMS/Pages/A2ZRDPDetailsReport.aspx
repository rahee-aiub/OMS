<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="A2ZRDPDetailsReport.aspx.cs" Inherits="ATOZWEBOMS.Pages.A2ZRDPDetailsReport" %>
        ...
        <table class="style1">
            <thead>
             ...
             <tr>
                    ...
                    <td colspan="8">
                      <asp:RadioButton ID="rbtOptDetails" runat="server" GroupName="GLRptGrpPrm" Font-Size="Large" Text="Details" Checked="true" Style="font-weight: 700" Font-Italic="True"/>
                        &nbsp;&nbsp; &nbsp;&nbsp;  
                           <asp:RadioButton ID="rbtOptSummary" runat="server" GroupName="GLRptGrpPrm" Font-Size="Large" Text="Summary" Style="font-weight: 700" Font-Italic="True"/>
                    </td>
