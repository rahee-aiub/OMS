...
{
    public partial class A2ZOMSOrderCancelFactory : System.Web.UI.Page
    {
        ...
        private void LoadReceiveGridSpooler()
        {
            ...
            string sqlquery = "SELECT OrderNo,OrderDate,ItemName,ItemKarat,ItemPiece,ItemTotalWeight,A2ZPARTYCODE.PartyName,OrderStatus,OrderStatusDesc FROM A2ZORDERDETAILS inner join A2ZPARTYCODE on A2ZPARTYCODE.PartyCode=A2ZORDERDETAILS.OrderParty WHERE OrderStatus < 90";
        ...
        protected void BtnPrint_Click(object sender, EventArgs e)
        {
            ...
            //try
            //{
            //    if (btnVerify.Visible == false && BtnReject.Visible == false)
            //    {
            //        Session["ProgFlag"] = "1";
            //        Session["SlblModule"] = lblModule.Text;
            //        Session["SlblBranchNo"] = lblBranchNo.Text;
            //        Session["SddlBranchNo"] = ddlBranchNo.Text;
            ...
            //        Label Acctype = (Label)gvLoanInfo.Rows[r.RowIndex].Cells[5].FindControl("lblAccType");
            //        Label AppNoR = (Label)gvLoanInfo.Rows[r.RowIndex].Cells[6].FindControl("lblappno");

            //        var prm = new object[11];

            //        prm[0] = lblBranchNo.Text;
            //        prm[1] = 0;
            //        prm[2] = 0;
            //        prm[3] = AppNoR.Text;
            ...
            //        int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_rptLoanApplicationReport", prm, "A2ZCSCUBS"));
            //        if (result == 0)
            //        {
            ...
            //        SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_TDATE, Converter.GetDateToYYYYMMDD(lblProcDate.Text));
            ...
            //        SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_DATABASE_NAME_KEY, "A2ZCSCUBS");


            //        SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_FILE_NAME_KEY, "rptLoanApplicationReport");
        ...
        protected void btnCancelOrder_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                prm[2] = "98";//OrderStatus
                prm[3] = "Order Cancel From Factory";//OrderStatusDesc;

                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_OrderCancel", prm, "A2ZACOMS"));
                if (result == 0)
                {
                    Response.Redirect(Request.RawUrl);
                }
