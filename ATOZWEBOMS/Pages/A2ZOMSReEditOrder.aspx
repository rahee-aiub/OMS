<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="A2ZOMSReEditOrder.aspx.cs" Inherits="ATOZWEBOMS.Pages.A2ZOMSReEditOrder" Title="Edit Order" %>
                ...
                <td style="vertical-align: top">
                    <table class="style1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlKarat" runat="server" CssClass="cls text" Width="170px" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Large">
                                    <asp:ListItem Value="0">-Select-</asp:ListItem>
