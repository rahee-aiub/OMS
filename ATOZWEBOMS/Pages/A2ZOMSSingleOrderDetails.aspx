<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="A2ZOMSSingleOrderDetails.aspx.cs" Inherits="ATOZWEBOMS.Pages.A2ZOMSSingleOrderDetails" Title="Order Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="DivMain" runat="server" align="center">
        <table class="style1">
            ...
            <tr>
                ...
                <td>
                      <asp:TextBox ID="txtOrderNo" runat="server" CssClass="cls text" Width="165px" Height="27px" BorderColor="#1293D1" BorderStyle="Ridge"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtOrderParty" runat="server" CssClass="cls text" Width="300px" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" TabIndex="5" Enabled="False"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlWayToOrder" runat="server" CssClass="cls text" Width="170px" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" TabIndex="5" Enabled="False">
                ...
                <td style="vertical-align: top">
                    <table class="style1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlItemName" runat="server" CssClass="cls text" Width="170px" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Large" TabIndex="4" Enabled="False">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtKarat" runat="server" CssClass="cls text" Width="165px" Height="27px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Large" Enabled="False"></asp:TextBox>
                            </td>
                        </tr>
    ...
    <asp:Label ID="lblCtrlFlag" runat="server" Visible="False"></asp:Label>
