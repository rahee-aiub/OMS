<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="A2ZOMSReadyInFactory.aspx.cs" Inherits="ATOZWEBOMS.Pages.A2ZOMSReadyInFactory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <tr>
                    <th>
                        <p align="center" style="color: blue">
                            Order Ready In Factory - Spooler&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div id="dvJpgTable" align="center" runat="server">
        ...
        <table class="style1">
             ...
             <tr>
                <td>
                    <asp:Label ID="Label6" runat="server" Text="Factory Name : " ForeColor="Green" Font-Size="Large"></asp:Label>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label5" runat="server" Text="Actual Weight : " ForeColor="Green" Font-Size="Large"></asp:Label>

                </td>
                <td colspan="3">
                    <asp:TextBox ID="txtActualWeight" runat="server" CssClass="cls text" Width="150px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
            ...
            <table>
                <tr>
                    <td colspan="6" align="center">
                        <asp:Button ID="btnReady" runat="server" Text="Ready In Factory" Font-Size="Large" ForeColor="#FFFFCC"
                            Height="30px" Width="180px" Font-Bold="True" CausesValidation="False"
                            CssClass="button green" OnClientClick="return ValidationBeforeSave()" OnClick="btnReady_Click" />
                        &nbsp;
