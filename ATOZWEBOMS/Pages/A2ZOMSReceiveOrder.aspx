<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="A2ZOMSReceiveOrder.aspx.cs" Inherits="ATOZWEBOMS.Pages.A2ZOMSReceiveOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="DivGridViewOrder" runat="server" align="center" style="height: 276px; overflow: auto; width: 100%;">
        <table class="style1">
            <thead>
                <tr>
                    <th>
                        <p align="center" style="color: blue">
                            Receive Order - Spooler&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <asp:GridView ID="gvOrderInfo" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" Style="margin-top: 4px" Width="957px">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Factory Party" ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="DarkBlue" HeaderStyle-Width="200px" ItemStyle-Width="200px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFactoryParty" runat="server" Text='<%# Eval("FactoryName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
    ...
    <div id="dvJpgTable" align="center" runat="server">
                ...
                <td>
                    ...
                    <asp:Image ID="ImgPicture" runat="server" Style="margin-top: 4px; height: 300px; width: 300px" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label38" runat="server" Text="Color : " Font-Size="Large"></asp:Label>
                            </td>
                            <td>
        ...
        <table class="style1">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlFactoryParty" runat="server" Enabled="false" CssClass="cls text" Width="300px" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
            ...
            <tr>
                <td>
                    <asp:Label ID="Label6" runat="server" Text="Whom Receive : " ForeColor="Green" Font-Size="Large"></asp:Label>

                </td>
                <td colspan="3">
                    <asp:TextBox ID="txtWhomReceive" runat="server" CssClass="cls text" MaxLength="40" Width="293px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
            ...
            <tr>
                <td>
                    <asp:Label ID="Label7" runat="server" Text="Whom Phone No. : " ForeColor="Green" Font-Size="Large"></asp:Label>

                </td>
                <td colspan="3">
                    <asp:TextBox ID="txtWhomPhone" runat="server" CssClass="cls text" MaxLength="30" Width="293px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" TabIndex="6"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtRcvOrderDesc" runat="server" CssClass="cls text" MaxLength="50" Width="693px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" TabIndex="6"></asp:TextBox>
                </td>
            </tr>
            ...
            <table>
                <tr>
                    <td colspan="6" align="center">
                        <asp:Button ID="btnReceive" runat="server" Text="Receive" Font-Size="Large" ForeColor="#FFFFCC"
                            Height="30px" Width="120px" Font-Bold="True" CausesValidation="False"
                            CssClass="button green" OnClick="btnReceive_Click" />
                        &nbsp;
