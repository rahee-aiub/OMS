...
{
    public partial class A2ZOMSReadyInFactory : System.Web.UI.Page
    {
        ...
        protected void BtnSelect_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    CtrlOrderParty.Text = Converter.GetString(dt.Rows[0]["OrderParty"]);
        ...
        protected void btnReady_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                prm[2] = txtActualWeight.Text;
                prm[3] = txtRcvOrderDesc.Text;
                prm[4] = "17";//OrderStatus
                prm[5] = "Ready In Factory";//OrderStatusDesc;
                prm[6] = CtrlOrderParty.Text;
                prm[7] = ddlFactoryParty.SelectedValue;
                prm[8] = lblID.Text;

                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_OrderReadyInFactory", prm, "A2ZACOMS"));
                if (result == 0)
                {
                    Response.Redirect(Request.RawUrl);
                }
