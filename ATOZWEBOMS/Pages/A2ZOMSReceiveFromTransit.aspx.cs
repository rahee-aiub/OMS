...
{
    public partial class A2ZOMSReceiveFromTransit : System.Web.UI.Page
    {
        ...
        {
            string sqlquery = "SELECT AccTrackingCode,CONCAT(AccTrackingCode,' - ',A2ZPARTYCODE.PartyName,' - ',A2ZPARTYCODE_1.PartyName, ' - ',AccBalance) AS AccInfo FROM A2ZACCOUNT LEFT OUTER JOIN A2ZPARTYCODE on A2ZPARTYCODE.PartyCode=A2ZACCOUNT.OrderParty LEFT OUTER JOIN dbo.A2ZPARTYCODE AS A2ZPARTYCODE_1 ON dbo.A2ZACCOUNT.FactoryParty = A2ZPARTYCODE_1.PartyCode WHERE AccNo='" + ddlTransitParty.SelectedValue + "' AND AccLocation = 2 AND AccBalance > 0";
        ...
        {
            string qry = "SELECT AccBalance FROM A2ZACCOUNT WHERE AccLocation = 2 AND AccNo = " + ddlTransitParty.SelectedValue + " AND AccTrackingCode = " + ddlOrderNo.SelectedValue + "";
        ...
        protected void txtGrossWt_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                prm[2] = ddlOrderNo.SelectedValue; // RefTrnKeyNo
                prm[3] = "3"; // FuncOpt
                prm[4] = "Receive From Transit"; //FuncOptDesc
                prm[5] = txtGrossWt.Text; // TrnAmount 
                prm[6] = lblID.Text; // UserID

                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("[Sp_InsertWfReceiveTransit]", prm, "A2ZACOMS"));
        ...
        protected void ddlTransitParty_SelectedIndexChanged(object sender, EventArgs e)
        {
            OrderNoDropdown();
        }
