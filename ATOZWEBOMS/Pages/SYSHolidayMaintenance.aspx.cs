...
namespace ATOZWEBOMS.Pages
{
    public partial class SYSHolidayMaintenance : System.Web.UI.Page
    {
        ...
        private void dropdown()
        {
            ...
            ddlHolType = DataAccessLayer.BLL.CommonManager.Instance.FillDropDownList(sqlquery, ddlHolType, "A2ZHKOMS");
        }
        ...
        {
            string sqlquery3 = "SELECT HolDate,HolType,HolTypeDesc,HolNote FROM A2ZHOLIDAY ORDER BY HolDate";
            gvDetailInfo = DataAccessLayer.BLL.CommonManager.Instance.FillGridViewList(sqlquery3, gvDetailInfo, "A2ZHKOMS");
        }
        ...
        protected void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            int rowEffect = Converter.GetInteger(DataAccessLayer.BLL.CommonManager.Instance.ExecuteNonQuery(qry, "A2ZHKOMS"));
            if(rowEffect>0)
            {
                gvDetail();
                clearinfo();
