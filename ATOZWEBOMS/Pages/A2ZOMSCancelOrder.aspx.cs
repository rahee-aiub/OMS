...
{
    public partial class A2ZOMSCancelOrder : System.Web.UI.Page
    {
        ...
        protected void ddlOrderNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlOrderNo.SelectedIndex != 0)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    ddlItemName.SelectedValue = Converter.GetString(dt.Rows[0]["OrderItemName"]);
                    ...
                    txtPiece.Text = Converter.GetString(dt.Rows[0]["ItemQuantity"]);
                    ...
                    txtquantity.Text = Converter.GetString(dt.Rows[0]["ItemQuantity"]);
