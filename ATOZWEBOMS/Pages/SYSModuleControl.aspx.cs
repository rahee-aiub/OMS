...
namespace ATOZWEBOMS.Pages
{
    public partial class SYSModuleControl : System.Web.UI.Page
    {
        ...
        private void Iniatialized()
        {
            ...
            gvModule = DataAccessLayer.BLL.CommonManager.Instance.FillGridViewList(strQuery, gvModule, "A2ZHKOMS");
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rowEffiect = Converter.GetSmallInteger(DataAccessLayer.BLL.CommonManager.Instance.ExecuteNonQuery(sqlQuery, "A2ZHKOMS"));
