<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="A2ZOMSSendToFactory.aspx.cs" Inherits="ATOZWEBOMS.Pages.A2ZOMSSendToFactory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="DivGridViewOrder" runat="server" align="center" style="height: 260px; overflow: auto; width: 100%;">
        <table class="style1">
            <thead>
                <tr>
                    <th>
                        <p align="center" style="color: blue">
                            Order Send To Factory  - Spooler&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <asp:GridView ID="gvOrderInfo" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" Style="margin-top: 4px" Width="957px">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Order Status" Visible="false" ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="DarkBlue" HeaderStyle-Width="100px" ItemStyle-Width="100px">
                                    <ItemTemplate>
    ...
    <div id="dvJpgTable" align="center" runat="server">
        ...
        <table class="style1">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtOrderDesc" runat="server" CssClass="cls text" MaxLength="50" Width="693px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
        ...
        <div id="Div1" runat="server" align="center">
            <table>
                <tr>
                    <td colspan="6" align="center">
                        <asp:Button ID="btnSend" runat="server" Text="Send" Font-Size="Large" ForeColor="#FFFFCC"
                            Height="30px" Width="120px" Font-Bold="True" CausesValidation="False"
                            CssClass="button green" OnClientClick="return ValidationBeforeSave()" OnClick="btnSend_Click" />
                        &nbsp;
    ...
    <asp:Label ID="CtrlOrdStatus" runat="server" Text="" Visible="false"></asp:Label>
