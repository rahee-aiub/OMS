<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="A2ZOMSSendToTransit.aspx.cs" Inherits="ATOZWEBOMS.Pages.A2ZOMSSendToTransit" Title="Send To Transit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="DivMain" runat="server" align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="4">Order Send to Transit
                    </th>
                </tr>
            </thead>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label10" runat="server" Text="Transit Party : " Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>

                <td>
                    <asp:DropDownList ID="ddlTransitParty" runat="server" CssClass="cls text" Width="400px" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                ...
                <td colspan="2">
                    <div align="center" class="grid_scroll" style="height: 250px;">
                        <asp:GridView ID="gvDetails" runat="server" HeaderStyle-BackColor="DarkBlue"
                            AutoGenerateColumns="False" AlternatingRowStyle-BackColor="DarkBlue" RowStyle-Height="10px" EnableModelValidation="True" OnRowDeleting="gvItemDetails_RowDeleting" Width="443px">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Order No." HeaderStyle-Width="320px" ItemStyle-Width="320px" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
