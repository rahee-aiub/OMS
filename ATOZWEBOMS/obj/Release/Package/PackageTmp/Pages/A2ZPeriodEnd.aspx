<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="A2ZPeriodEnd.aspx.cs" Inherits="ATOZWEBOMS.Pages.A2ZPeriodEnd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="CtrlLoanIntStat" runat="server" Text="" Visible="false"></asp:Label>
