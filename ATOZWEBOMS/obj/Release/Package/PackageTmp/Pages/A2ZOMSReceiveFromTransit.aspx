<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="A2ZOMSReceiveFromTransit.aspx.cs" Inherits="ATOZWEBOMS.Pages.A2ZOMSReceiveFromTransit" Title="Receive From Transit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="DivMain" runat="server" align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="4">Order Receive From Transit
                    </th>
                </tr>
            </thead>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlTransitParty" runat="server" CssClass="cls text" Width="400px" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" TabIndex="5" AutoPostBack="true" OnSelectedIndexChanged="ddlTransitParty_SelectedIndexChanged">
                    </asp:DropDownList>
